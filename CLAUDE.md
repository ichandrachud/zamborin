...
| What "good" means, across every product | `~/Library/Mobile Documents/com~apple~CloudDocs/Claude Projects/Design Systems/GOOD-DESIGN.md` — the definition and its tests; `DESIGN-SYSTEM.md` is the games' operational form of it. |
