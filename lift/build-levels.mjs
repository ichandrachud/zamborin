/* Lift — the level builder, and the certificate every level carries.
 *
 ...
 *
 * Run: node lift/build-levels.mjs   (writes lift/levels.js)
 */
...
const body = `/* Lift — the shipped levels. GENERATED by build-levels.mjs; do not hand-edit.
 *
...
console.log('\n  wrote lift/levels.js — ' + out.length + ' levels: ' +
