...
// PROTOTYPE ONLY — one turbo boost per flight, spent by tapping while airborne.
...
// Its OWN key. Same origin as /tailwind/, so sharing this would let boosted
// distances overwrite the real game's saved records.
const KEY = 'zamborin.tailwind-boost.bests';
function loadBests() {
...
// PROTOTYPE. Airspeed is shown because the rule the boost turns on is "energy
