...
| FO5 | fold | MINOR, bounded, and it is the same shape as K6 | After FO4 the only frame still overlapping is **568x320, iPhone SE in landscape**, at 26px, down from 81px. The boundary is sharp: clean at 344px tall and above, then 340 gives 6px, 336 gives 4px, 328 gives 12px, 320 gives 26px, 318 gives 37px. Everything the site documents is clear, including 480x360. Closing it means cutting the total score or the figure's name, which is more than the frame is worth. **This is K6 again in a different game: the real gap is that /embed/ states no minimum.** | OPEN, folds into the K6 decision |
