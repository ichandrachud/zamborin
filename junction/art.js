...
/* THE CARRIAGES, from the owner's drawings, on the same artboard and in the
   same frame as the engine — so a coach coupled behind it lines up without a
   single hand-tuned offset. All three are exactly 94.37 x 163.67, which is
   what makes them interchangeable in a rake.

   Colours are ROLES, as they are for the engine. The chassis greys are shared
   by all three so a mixed train still reads as one train; only a COACH takes
   the engine's livery. A flat wagon's load and a tanker's hazard bands keep
   what they were drawn in, because on a real railway the loco and its coaches
   match and the freight does not. */
const CARS = {
  coach: { x: 250.44, y: 338.82, w: 94.37, h: 163.67, ops: [
      { t: 'rect', f: 'body', x: 256.49, y: 338.82, w: 82.36, h: 163.67 },
      { t: 'rect', f: 'bodyLit', x: 310.72, y: 338.82, w: 18.15, h: 163.67 },
      { t: 'circle', f: 'grey', cx: 299.7, cy: 366.82, r: 6.33 },
      { t: 'circle', f: 'grey', cx: 299.7, cy: 475.49, r: 6.33 },
      { t: 'circle', f: 'grey', cx: 299.7, cy: 420.65, r: 6.33 },
      { t: 'path', f: 'iron', d: 'M343.19,373.92c.89,0,1.62-2.11,1.62-4.71s-.72-4.71-1.62-4.71-1.62,2.11-1.62,4.71.72,4.71,1.62,4.71Z' },
      { t: 'rect', f: 'grey', x: 338.85, y: 351.96, w: 4.43, h: 34.5 },
      { t: 'rect', f: 'greyLit', x: 338.85, y: 376.64, w: 4.43, h: 8.21 },
      { t: 'path', f: 'iron', d: 'M343.19,423.05c.89,0,1.62-2.11,1.62-4.71s-.72-4.71-1.62-4.71-1.62,2.11-1.62,4.71.72,4.71,1.62,4.71Z' },
      { t: 'rect', f: 'grey', x: 338.85, y: 401.09, w: 4.43, h: 34.5 },
      { t: 'rect', f: 'greyLit', x: 338.85, y: 425.76, w: 4.43, h: 8.21 },
      { t: 'path', f: 'iron', d: 'M343.19,472.17c.89,0,1.62-2.11,1.62-4.71s-.72-4.71-1.62-4.71-1.62,2.11-1.62,4.71.72,4.71,1.62,4.71Z' },
      { t: 'rect', f: 'grey', x: 338.85, y: 450.21, w: 4.43, h: 34.5 },
      { t: 'rect', f: 'greyLit', x: 338.85, y: 474.89, w: 4.43, h: 8.21 },
      { t: 'path', f: 'iron', d: 'M252.06,373.92c.89,0,1.62-2.11,1.62-4.71s-.72-4.71-1.62-4.71-1.62,2.11-1.62,4.71.72,4.71,1.62,4.71Z' },
      { t: 'rect', f: 'grey', x: 252.06, y: 351.96, w: 4.43, h: 34.5 },
      { t: 'rect', f: 'greyLit', x: 252.06, y: 376.64, w: 4.43, h: 8.21 },
      { t: 'path', f: 'iron', d: 'M252.06,423.05c.89,0,1.62-2.11,1.62-4.71s-.72-4.71-1.62-4.71-1.62,2.11-1.62,4.71.72,4.71,1.62,4.71Z' },
      { t: 'rect', f: 'grey', x: 252.06, y: 401.09, w: 4.43, h: 34.5 },
      { t: 'rect', f: 'greyLit', x: 252.06, y: 425.76, w: 4.43, h: 8.21 },
      { t: 'path', f: 'iron', d: 'M252.06,472.17c.89,0,1.62-2.11,1.62-4.71s-.72-4.71-1.62-4.71-1.62,2.11-1.62,4.71.72,4.71,1.62,4.71Z' },
      { t: 'rect', f: 'grey', x: 252.06, y: 450.21, w: 4.43, h: 34.5 },
      { t: 'rect', f: 'greyLit', x: 252.06, y: 474.89, w: 4.43, h: 8.21 },
  ] },
  carrier: { x: 250.44, y: 338.82, w: 94.37, h: 163.67, ops: [
      { t: 'rect', f: 'loadLit', x: 256.49, y: 338.82, w: 82.36, h: 163.67 },
      { t: 'rect', f: 'load', x: 261.62, y: 343.49, w: 72.11, h: 154.33 },
      { t: 'rect', f: 'loadMid', x: 261.62, y: 343.49, w: 62, h: 142 },
      { t: 'path', f: 'iron', d: 'M343.19,375.76c.89,0,1.62-2.11,1.62-4.71s-.72-4.71-1.62-4.71-1.62,2.11-1.62,4.71.72,4.71,1.62,4.71Z' },
      { t: 'rect', f: 'grey', x: 338.85, y: 353.79, w: 4.43, h: 34.5 },
      { t: 'rect', f: 'greyLit', x: 338.85, y: 378.47, w: 4.43, h: 8.21 },
      { t: 'path', f: 'iron', d: 'M343.19,424.88c.89,0,1.62-2.11,1.62-4.71s-.72-4.71-1.62-4.71-1.62,2.11-1.62,4.71.72,4.71,1.62,4.71Z' },
      { t: 'rect', f: 'grey', x: 338.85, y: 402.92, w: 4.43, h: 34.5 },
      { t: 'rect', f: 'greyLit', x: 338.85, y: 427.6, w: 4.43, h: 8.21 },
      { t: 'path', f: 'iron', d: 'M343.19,474.01c.89,0,1.62-2.11,1.62-4.71s-.72-4.71-1.62-4.71-1.62,2.11-1.62,4.71.72,4.71,1.62,4.71Z' },
      { t: 'rect', f: 'grey', x: 338.85, y: 452.04, w: 4.43, h: 34.5 },
      { t: 'rect', f: 'greyLit', x: 338.85, y: 476.72, w: 4.43, h: 8.21 },
      { t: 'path', f: 'iron', d: 'M252.06,375.76c.89,0,1.62-2.11,1.62-4.71s-.72-4.71-1.62-4.71-1.62,2.11-1.62,4.71.72,4.71,1.62,4.71Z' },
      { t: 'rect', f: 'grey', x: 252.06, y: 353.79, w: 4.43, h: 34.5 },
      { t: 'rect', f: 'greyLit', x: 252.06, y: 378.47, w: 4.43, h: 8.21 },
      { t: 'path', f: 'iron', d: 'M252.06,424.88c.89,0,1.62-2.11,1.62-4.71s-.72-4.71-1.62-4.71-1.62,2.11-1.62,4.71.72,4.71,1.62,4.71Z' },
      { t: 'rect', f: 'grey', x: 252.06, y: 402.92, w: 4.43, h: 34.5 },
      { t: 'rect', f: 'greyLit', x: 252.06, y: 427.6, w: 4.43, h: 8.21 },
      { t: 'path', f: 'iron', d: 'M252.06,474.01c.89,0,1.62-2.11,1.62-4.71s-.72-4.71-1.62-4.71-1.62,2.11-1.62,4.71.72,4.71,1.62,4.71Z' },
      { t: 'rect', f: 'grey', x: 252.06, y: 452.04, w: 4.43, h: 34.5 },
      { t: 'rect', f: 'greyLit', x: 252.06, y: 476.72, w: 4.43, h: 8.21 },
  ] },
  oiltank: { x: 250.44, y: 338.82, w: 94.37, h: 163.67, ops: [
      { t: 'rect', f: 'iron', x: 266.48, y: 338.82, w: 62.39, h: 163.67 },
      { t: 'rect', f: 'bandLit', x: 256.49, y: 346.82, w: 82.36, h: 147.67 },
      { t: 'rect', f: 'band', x: 310.72, y: 346.82, w: 18.15, h: 147.67 },
      { t: 'path', f: 'iron', d: 'M343.19,378.42c.89,0,1.62-2.11,1.62-4.71s-.72-4.71-1.62-4.71-1.62,2.11-1.62,4.71.72,4.71,1.62,4.71Z' },
      { t: 'rect', f: 'grey', x: 338.85, y: 356.46, w: 4.43, h: 34.5 },
      { t: 'rect', f: 'greyLit', x: 338.85, y: 381.14, w: 4.43, h: 8.21 },
      { t: 'path', f: 'iron', d: 'M343.19,427.55c.89,0,1.62-2.11,1.62-4.71s-.72-4.71-1.62-4.71-1.62,2.11-1.62,4.71.72,4.71,1.62,4.71Z' },
      { t: 'rect', f: 'grey', x: 338.85, y: 405.59, w: 4.43, h: 34.5 },
      { t: 'rect', f: 'greyLit', x: 338.85, y: 430.26, w: 4.43, h: 8.21 },
      { t: 'path', f: 'iron', d: 'M343.19,476.67c.89,0,1.62-2.11,1.62-4.71s-.72-4.71-1.62-4.71-1.62,2.11-1.62,4.71.72,4.71,1.62,4.71Z' },
      { t: 'rect', f: 'grey', x: 338.85, y: 454.71, w: 4.43, h: 34.5 },
      { t: 'rect', f: 'greyLit', x: 338.85, y: 479.39, w: 4.43, h: 8.21 },
      { t: 'path', f: 'iron', d: 'M252.06,378.42c.89,0,1.62-2.11,1.62-4.71s-.72-4.71-1.62-4.71-1.62,2.11-1.62,4.71.72,4.71,1.62,4.71Z' },
      { t: 'rect', f: 'grey', x: 252.06, y: 356.46, w: 4.43, h: 34.5 },
      { t: 'rect', f: 'greyLit', x: 252.06, y: 381.14, w: 4.43, h: 8.21 },
      { t: 'path', f: 'iron', d: 'M252.06,427.55c.89,0,1.62-2.11,1.62-4.71s-.72-4.71-1.62-4.71-1.62,2.11-1.62,4.71.72,4.71,1.62,4.71Z' },
      { t: 'rect', f: 'grey', x: 252.06, y: 405.59, w: 4.43, h: 34.5 },
      { t: 'rect', f: 'greyLit', x: 252.06, y: 430.26, w: 4.43, h: 8.21 },
      { t: 'path', f: 'iron', d: 'M252.06,476.67c.89,0,1.62-2.11,1.62-4.71s-.72-4.71-1.62-4.71-1.62,2.11-1.62,4.71.72,4.71,1.62,4.71Z' },
      { t: 'rect', f: 'grey', x: 252.06, y: 454.71, w: 4.43, h: 34.5 },
      { t: 'rect', f: 'greyLit', x: 252.06, y: 479.39, w: 4.43, h: 8.21 },
      { t: 'line', s: 'iron', x1: 288.89, y1: 370.35, x2: 256.58, y2: 370.35 },
      { t: 'line', s: 'iron', x1: 288.89, y1: 378.4, x2: 256.58, y2: 378.4 },
      { t: 'line', s: 'iron', x1: 285.94, y1: 370.14, x2: 285.94, y2: 378.4 },
      { t: 'line', s: 'iron', x1: 280.34, y1: 370.14, x2: 280.34, y2: 378.4 },
      { t: 'line', s: 'iron', x1: 274.74, y1: 370.14, x2: 274.74, y2: 378.4 },
      { t: 'line', s: 'iron', x1: 269.14, y1: 370.14, x2: 269.14, y2: 378.4 },
      { t: 'line', s: 'iron', x1: 263.54, y1: 370.14, x2: 263.54, y2: 378.4 },
      { t: 'line', s: 'iron', x1: 257.94, y1: 370.14, x2: 257.94, y2: 378.4 },
      { t: 'circle', f: 'grey', cx: 299.2, cy: 374.65, r: 11.83 },
      { t: 'path', f: 'tank', d: 'M305.72,380.89c-3.25,2.34-6.85-1.25-4.5-4.5.05-.07.11-.13.18-.18,3.25-2.34,6.85,1.25,4.5,4.5-.05.07-.11.13-.18.18Z' },
      { t: 'circle', f: 'grey', cx: 299.2, cy: 464.15, r: 11.83 },
      { t: 'path', f: 'tank', d: 'M305.72,471.39c-3.25,2.34-6.85-1.25-4.5-4.5.05-.07.11-.13.18-.18,3.25-2.34,6.85,1.25,4.5,4.5-.05.07-.11.13-.18.18Z' },
  ] },
};

return { TREES, ENGINE, CARS };
}));
